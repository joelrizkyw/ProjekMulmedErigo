			...
			<Container className="content">
				<Row className="mb-4">
					{data.images.map((it, i) =>
						<Col><img className="w-100" src={it} key={i}/></Col>
					)}
				</Row>
				<div className="articleBody d-flex flex-column align-items-center">
					<Col lg={8}>
						{parse(data.body)}
					</Col>
				</div>
